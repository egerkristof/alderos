...
if (stored && ["en", "de", "es", "fr", "it", "hu", "pt", "pl"].includes(stored)) return stored as Language;
    const browserLang = navigator.language.slice(0, 2);
    if (["en", "de", "es", "fr", "it", "hu", "pt", "pl"].includes(browserLang)) return browserLang as Language;
    return "en";
  });
